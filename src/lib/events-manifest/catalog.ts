...
const ENTRIES: EventCatalogEntry[] = [
  {
    ...
    schema: { required: { id: f('uuid'), source: f('string') }, optional: contactIdentityOptionalFields, allowExtraProperties: true },
  },
  {
  ...
  },
  {
    ...
    schema: { required: {}, optional: {}, allowExtraProperties: true },
  },
];
